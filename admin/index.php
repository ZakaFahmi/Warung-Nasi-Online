...
<html>
    ...
    <body class="skin-blue">
                ...
                <section class="content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-xs-6">
                            <!-- small box -->
                            <?php
                            $tampil1 = mysqli_query($koneksi, "SELECT * FROM cart");
                            $dept = mysqli_num_rows($tampil1);
                            ?>
                            <div class="small-box bg-green">
                                <div class="inner">
                                    <h3>
                                        <?= "$dept"; ?> <!--<sup style="font-size: 20px">%</sup>-->
                                    </h3>
                                    <p>
                                        PO (Purchase Order)
                                    </p>
                        ...
                        <div class="col-lg-3 col-xs-6">
                            <!-- small box -->
                            <?php 
                            $tampil2 = mysqli_query($koneksi, "SELECT * FROM customer");
                        ...
                        <div class="col-lg-3 col-xs-6">
                        <?php
                        $tampil3 = mysqli_query($koneksi, "SELECT * FROM admin");
                        ...
                        <section class="col-lg-7 connectedSortable">                            
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <?php
                                    $query1="SELECT nama, harga FROM produk ORDER BY id DESC limit 5";
                                    ...
                                    <table id="example" class="table table-hover table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="detail-karyawan.php?hal=edit&kd=<?php echo $data['kode'];?>"><span class="glyphicon glyphicon-user"></span> <?php echo $data['nama'];?>
                                                </td>
                                                <td>
                        ...
                        <section class="col-lg-5 connectedSortable"> 
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                        <!-- <div class="table-responsive"> -->
                                    <?php
                                    $query2 = "SELECT id, username, fullname FROM admin ORDER BY id DESC LIMIT 5";
                                    ...
                                    <table id="example" class="table table-hover table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <center>
                                                        <a href="detail-admin.php?hal=edit&kd=<?php echo $data1['id'];?>"><span class="glyphicon glyphicon-user"></span> <?php echo $data1['username']; ?></a>
                                                    </center>
                                                </td>
                                                <td>
                                    ...
                                    <!-- </div>-->
                                    <div class="text-right">
                                        <a href="admin.php" class="btn btn-sm btn-info">
                                            Menu Admin <i class="fa fa-arrow-circle-right"></i>
                                        </a>
                                    </div>
                                </div>
                            </div>
        ...
        <!-- </div>/.row (main row) </section>/.content -->
<!-- </aside> --> -->
<!-- </div>./wrapper -->
