...
$id = $_GET['id'];
$sql = mysqli_query($koneksi, "SELECT * FROM produk WHERE id=$id") or mysqli_error($koneksi);
...
if(isset($_POST['update'])) {
    ...
    if (!empty($_FILES['nama_file']['tmp_name'])) {
        ...
        if($jenis_gambar=="image/jpeg" 
            ...
            || $jenis_gambar=="image/gif"
            || $jenis_gambar=="image/x-png") {
            
            $gambar = $namafolder . basename($_FILES['nama_file']['name']);		
            if (move_uploaded_file($_FILES['nama_file']['tmp_name'], $gambar)) {
                $sql = "UPDATE produk SET nama='$nama', jenis='$jenis', harga=$harga, keterangan='$keterangan', stok=$stok WHERE id=$id";
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="detail-admin.php?hal=edit&kd=<?= $_SESSION['user_id'];?>" class="btn btn-default btn-flat">Profil</a>
                                    </div>
                                    ...
                                    <div class="form-panel">
                                        <form class="form-horizontal style-form" action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                            ...
                                            <div class="form-group">
                                                <label for="nama" class="col-sm-2 col-sm-2 control-label">Nama</label>
                                                <div class="col-sm-3">
                                            ...
                                            <div class="form-group">
                                                <label for="jenis" class="col-sm-2 col-sm-2 control-label">Jenis</label>
                                                <div class="col-sm-3">
                                            ...
                                            <div class="form-group">
                                                <label for="harga" class="col-sm-2 col-sm-2 control-label">Harga</label>
                                                    <div class="col-sm-3">
                                            ...
                                            <div class="form-group">
                                                <label for="keterangan" class="col-sm-2 col-sm-2 control-label">Keterangan</label>
                                                <div class="col-sm-3">
                                            ...
                                            <div class="form-group">
                                                <label for="stok" class="col-sm-2 col-sm-2 control-label">Stok</label>
                                                <div class="col-sm-3">
                                            ...
                                            <div class="form-group">
                                                <label for="gambar" class="col-sm-2 col-sm-2 control-label">Foto Sebelumnya</label>
